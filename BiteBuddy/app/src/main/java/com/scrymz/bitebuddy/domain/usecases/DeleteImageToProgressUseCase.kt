...
class DeleteImageToProgressUseCase @Inject constructor(
    private val repository: ImageToProgressRepository
) {
    operator fun invoke(imageToProgress: ImageToProgress) = repository.deleteImageToProgress(imageToProgress)
}
