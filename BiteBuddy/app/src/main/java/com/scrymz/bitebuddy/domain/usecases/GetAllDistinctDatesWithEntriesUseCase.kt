...
class GetAllDistinctDatesWithEntriesUseCase @Inject constructor(
    private val repository: FoodDatabaseRepository
) {
    operator fun invoke(): Flow<ResultState<List<String>>> {
        return repository.getAllDistinctDatesWithEntries()
    }
}
